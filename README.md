...
For the coursework, keep the main report tight:

1. Paper summary and financial motivation.
2. Data and replication design.
3. PCA and autoencoder results.
4. Critical comparison, limitations, and financial interpretation.

Put implementation details or extra trading tables in an appendix if needed,
because the brief caps the main report at three pages excluding references and
appendices.
